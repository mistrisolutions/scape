            ...
            <div class="row my-3 my-md-5">
               <div class="col-md-10 mx-auto">
                  <div class="service-item px-2">
                     <div class="row d-flex mb-4 mb-md-5 shadow-sm rounded-lg py-3 py-md-4">
                        <div class="col-md-5 mb-3 mb-md-0">
                           <img class="img-fluid rounded-lg w-100 h-100" src="{{asset('assets/images/service/interior.png')}}" alt="">
                        </div>
                     ...
                     <div class="row d-flex mb-4 mb-md-5 shadow-sm rounded-lg py-3 py-md-4">
                        <div class="col-md-7 mb-3 mb-md-0 order-1 order-md-0">
                           <h1 class="mb-3 mb-md-4">Architectural & Engineering Consultant.</h1>
                           <p class="mb-3 mb-md-5">We believe that successful design originates from listening to the clients’ needs, implementing explicit concepts, and transforming them into physical form. Architectural services, both commercial and residential are provided by Scape Development Engineers. Here we help with the
                               <br>
                        ...
                        <div class="col-md-5 mb-3 mb-md-0 order-0 order-md-1">
                           <img class="img-fluid rounded-lg w-100 h-100" src="{{asset('assets/images/service/architect.png')}}" alt="">
                        </div>
                     </div> <!-- ./row -->
                     <div class="row d-flex mb-4 mb-md-5 shadow-sm rounded-lg py-3 py-md-4">
                        <div class="col-md-5 mb-3 mb-md-0">
                           <img class="img-fluid h-100 rounded-lg w-100 h-100" src="{{asset('assets/images/service/building.png')}}" alt="">
                        </div>
                        <div class="col-md-7 mb-3 mb-md-0">
                     ...
                     <div class="row d-flex mb-4 mb-md-5 shadow-sm rounded-lg py-3 py-md-4">
                        ...
                        <div class="col-md-5 mb-3 mb-md-0 order-0 order-md-1">
                           <img class="img-fluid rounded-lg w-100 h-100" src="{{asset('assets/images/service/landscaping.png')}}" alt="">
                        </div>
                     </div> <!-- ./row -->
                  </div>
               </div>
