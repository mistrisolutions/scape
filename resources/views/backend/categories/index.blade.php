...
<a  class="float-right" href="{{ route('app.categories.create') }}">
  <label class="badge badge-success">Create Category</label>
</a>
@endcan
@endsection
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center"> 
                @can('update',$category)
                <a href="{{ route('app.categories.edit',$category->id) }}" class="badge badge-success">Edit</a>
                @endcan
                @can('delete',$category)
